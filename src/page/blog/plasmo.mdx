...
在众多的 Web 扩展开发框架中，WXT 和 Plasmo 凭借其丰富的工具和特性，以及简化的<ZeroLink href="https://so.csdn.net/so/search?q=%E5%BC%80%E5%8F%91%E6%B5%81%E7%A8%8B&spm=1001.2101.3001.7020" blank>开发流程</ZeroLink>，成为开发者们的首选。

### Plasmo

<ZeroLink href="https://docs.plasmo.com/" blank>
  官网链接
</ZeroLink>
`Plasmo`
...
有关示例，请参见 <ZeroLink href="https://link.juejin.cn?target=https%3A%2F%2Fgithub.com%2FPlasmoHQ%2Fexamples%2Ftree%2Fmain%2Fwith-popup" blank>with-popup</ZeroLink>

#### 添加新标签页

创建一个 `newtab.tsx` 或 `newtab/index.tsx` 文件，Plasmo 将负责渲染您的新标签页

有关示例，请参见 <ZeroLink href="https://link.juejin.cn?target=https%3A%2F%2Fgithub.com%2FPlasmoHQ%2Fexamples%2Ftree%2Fmain%2Fwith-newtab" blank>with-newtab</ZeroLink>

#### 添加后台服务

在根目录创建一个 `background.ts` 文件

有关示例，请参见 <ZeroLink href="https://link.juejin.cn?target=https%3A%2F%2Fgithub.com%2FPlasmoHQ%2Fexamples%2Ftree%2Fmain%2Fwith-background" blank>with-background</ZeroLink>
...
有关示例，请参见 <ZeroLink href="https://link.juejin.cn?target=https%3A%2F%2Fgithub.com%2FPlasmoHQ%2Fexamples%2Ftree%2Fmain%2Fwith-content-script" blank>with-content-script</ZeroLink>
...
有关示例，请参见 <ZeroLink href="https://link.juejin.cn?target=https%3A%2F%2Fgithub.com%2FPlasmoHQ%2Fexamples%2Ftree%2Fmain%2Fwith-main-world-content-script-injection" blank>with-main-world-content-script-injection</ZeroLink>
...
1. 导出默认的 React 组件
2. 完成
   有关示例，请参见 <ZeroLink href="https://link.juejin.cn?target=https%3A%2F%2Fgithub.com%2FPlasmoHQ%2Fexamples%2Ftree%2Fmain%2Fwith-content-scripts-ui" blank>with-content-scripts-ui</ZeroLink>
...
- notifications
  <ZeroLink
    href="https://developer.chrome.com/docs/extensions/reference/api/notifications?hl=zh-cn"
    blank
  >
    用于在系统任务栏中向用户显示通知
  </ZeroLink>
...
- chrome.tabs.create
  <ZeroLink
    href="https://developer.chrome.com/docs/extensions/reference/api/tabs?hl=zh-cn#method-create"
    blank
  >
    创建新标签页
  </ZeroLink>
...
- chrome.tabs.query
  <ZeroLink
    href="https://developer.chrome.com/docs/extensions/reference/api/tabs?hl=zh-cn#method-query"
    blank
  >
...
- chrome.tabs.sendMessage
  <ZeroLink
    href="https://developer.chrome.com/docs/extensions/reference/api/tabs?hl=zh-cn#method-sendMessage"
    blank
  >
    向指定标签页中的 content 脚本发送一条消息，并在发回响应时运行一个可选回调
  </ZeroLink>
...
- chrome.runtime.sendMessage
  <ZeroLink
    href="https://developer.chrome.com/docs/extensions/reference/api/runtime?hl=zh-cn#method-sendMessage"
    blank
  >
    向扩展程序或其他扩展程序/应用中的事件监听器发送一条消息。请注意，扩展程序无法使用此方法向内容脚本发送消息
  </ZeroLink>
...
- chrome.runtime.onMessage.addListener
  ...
  - chrome.contextMenus.create
    <ZeroLink
      href="https://developer.chrome.com/docs/extensions/reference/api/contextMenus?hl=zh-cn#method-create"
      blank
    >
      创建右键菜单（上下文菜单添加项）
    </ZeroLink>
...
- <ZeroLink href="https://juejin.cn/post/7188738032248291385" blank>
    chrome 插件之通信
  </ZeroLink>
- <ZeroLink
    href="https://developer.chrome.com/docs/extensions/reference/api/action?hl=zh-cn"
    blank
  >
    浏览器插件开发 api
  </ZeroLink>
